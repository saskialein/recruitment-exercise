...
const triggerThree = () => (
    <div className={classes.QuestionContainer}>
      <h2 className={classes.Question}>Reading the ​introduction to <b>Mevo</b>​ on our developer site, <br/> what makes you the <b>most excited about</b> the potential of working as a Software Engineer here?</h2>
      <div className={classes.ExpandMore}>
            <ExpandMoreIcon style={{fontSize: '2rem'}} />
        </div>
    </div>
...
export default function Questions() {
    return (
        <section className={classes.SectionContainer}>
            ...
            >
                <p>My last Job as an Account Manager and Product Coordinator at ANZ Nature Tours has been my favourite job so far.
                ...
                For a lot of these clients, it was a 'bucket-list dream' and they have saved a significant amount of money to make this dream come true.
                    ...
                    <br /> I appreciated having this little extra responsibility and helping workmates whenever they were stuck.</p>
                <p>Besides that, I also enjoyed the people I worked with. It was a friendly and fun atmosphere, and I enjoyed going to work each morning.
                ...
                Sharing feelings, daily workload and road blocks opens up a whole new level of connection, support and
                    balances work more evenly amongst everyone. We also celebrated achievements with each other which was very rewarding and motivating.</p>
                <p>In addition, we had monthly 1:1s with our Operations Manager to discuss our performance, achievements, issues, frustrations and/or goals, 
            ...
            <Collapsible
                ...
                <p>I have actually been a fan of Mevo since I saw one of your super cool Audi e-trons outside of the Left Bank Arcade for the
                first time a few years back in 2017. <br />
                I remember, it immediately caught my attention and I went straight to your website to checkout this innovative service. </p>
                <p> Looking at the Mevo fleet now and also browsing through your press articles, it is fascinating as well as almost relieving to see, 
                ...
                <p> Besides being a big fan of your service (and your European cars), I am impressed by your digital first approach and ambitious technology,
                like keyless access to vehicles with mobile apps or the home zone indicator in your cars. </p>
                <p> I believe that Mevo is a company that allows me to grow at immense speed and it would truly excite me to work with your team behind the scenes
                to allow more users to have access to shared cars.
                Self-driving cars?
                </p>
            </Collapsible>
            <div className={classes.ContactContainer}>
                <a className={classes.NetworkingLink} href='https://github.com/saskialein' target='_blank' rel="noreferrer" ><GitHubIcon style={{fontSize: '3rem', padding: '10px'}}/></a>
                <a className={classes.NetworkingLink} href='https://www.linkedin.com/in/saskia-leinberger/' target='_blank' rel="noreferrer"><LinkedInIcon style={{fontSize: '3rem', padding: '10px'}}/></a>
            </div>
        </section>
    )
}